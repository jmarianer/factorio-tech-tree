...
python cli.py create-html -q --output output/base
python cli.py create-html -q --output output/k2spacex --mods space-exploration --mods space-exploration-postprocess --mods Krastorio2
python cli.py create-html -q --output output/spacex --mods space-exploration --mods space-exploration-postprocess
python cli.py create-html -q --output output/ind --mods IndustrialRevolution
python cli.py create-html -q --output output/angelbobs --mods SpaceMod --mods angelsaddons-storage --mods angelsbioprocessing --mods angelspetrochem --mods angelsrefining --mods angelssmelting --mods bobassembly --mods bobelectronics --mods bobenemies --mods bobequipment --mods bobinserters --mods boblibrary --mods boblogistics --mods bobmining --mods bobmodules --mods bobores --mods bobplates --mods bobpower --mods bobrevamp --mods bobtech --mods bobwarfare
