...
mkdir -p frontend/assets/{base,spacex,ind,angelbobs,k2spacex}

python backend/cli.py dump-data -q --output frontend/assets/base
python backend/cli.py dump-data -q --output frontend/assets/spacex --mods space-exploration --mods space-exploration-postprocess
